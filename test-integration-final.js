...
async function testIntegration() {
  ...
  console.log('计算中...\n');
  const chart = await calculateHumanDesignChart(birthDate, 28.8853, 105.4305);
  ...
  if (allCorrect) {
    console.log('✅ 所有南北交点数据正确！Swiss Ephemeris 集成成功！');
  } else {
    console.log('❌ 部分数据不正确');
  }
  console.log('========================================\n');
